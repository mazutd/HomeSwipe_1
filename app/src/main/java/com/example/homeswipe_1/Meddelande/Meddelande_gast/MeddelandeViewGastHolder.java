...
public class MeddelandeViewGastHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public MeddelandeViewGastHolder(@NonNull View itemView) {
        super(itemView);
